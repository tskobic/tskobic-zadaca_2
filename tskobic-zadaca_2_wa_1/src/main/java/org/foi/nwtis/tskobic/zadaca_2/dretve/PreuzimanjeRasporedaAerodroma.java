...
public class PreuzimanjeRasporedaAerodroma extends Thread {
	...
	public void run() {
		while(vrijemeObrade < preuzimanjeDo) {
    		...
    		try {
    			avioniPolasci = oSKlijent.getDepartures(ad.getIcao(), vrijemeObrade, vrijemeObrade + preuzimanjeVrijeme);
            ...
            System.out.println("Dolasci na aerodrom: " + ad.getIcao());
            List<AvionLeti> avioniDolasci;
    		try {
    			avioniDolasci = oSKlijent.getArrivals(ad.getIcao(), vrijemeObrade, vrijemeObrade + preuzimanjeVrijeme);
    		...
    		//TODO napravi malu pauzu između dva aerodroma
